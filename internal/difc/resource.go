...
func (c *CollectionLabeledData) Overall() *LabeledResource {
	logResource.Printf("CollectionLabeledData.Overall: aggregating labels for %d items", len(c.Items))
...
func (f *FilteredCollectionLabeledData) Overall() *LabeledResource {
	logResource.Printf("FilteredCollectionLabeledData.Overall: accessible=%d, filtered=%d, reason=%s",
...
func (f *FilteredCollectionLabeledData) ToResult() (interface{}, error) {
	logResource.Printf("FilteredCollectionLabeledData.ToResult: returning %d accessible items (filtered=%d)",
		len(f.Accessible), len(f.Filtered))
